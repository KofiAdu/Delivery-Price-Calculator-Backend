...
def calculate_delivery_fee(cart_value, delivery_distance, number_of_items, time):
    base_fee = 200
    additional_distance_fee_per_increment = 100
    ...
    additional_distance_fee = increments * additional_distance_fee_per_increment
    
    total_distance_fee = base_fee + additional_distance_fee
